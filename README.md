...
Sign-Up Form
(assets/Screenshots/sign_up_form.png)
The form features a custom sketch border effect created with CSS pseudo-elements.
Mobile Responsive
Show Image
Fully responsive design that adapts to all screen sizes.
Technologies Used
(assets/Screenshots/pseudo_elements_dounle_sketch_border.png)
...
(assets/Screenshots/CSS_fonts_import.png)
...
Typography
Show Image
Uses Kalam handwritten font from Google Fonts to maintain the hand-crafted aesthetic throughout.
Key Features
